...
// Кнопки второй змеи
	...
	function Game() {
		...
		// if(snakeHeadX >= 1000){
		//     for(let i = 0; i < snake.length; i++) {
		//         context.clearRect(snake.x, snake.y, cellSize, cellSize);
		//         context.beginPath();
		//         snake.x = 2;
		//         snake.y = 2;
		//         context.fillRect(snake[i].x, snake[i].y, cellSize, cellSize);
		...
		//         context.clearRect(snake.x, snake.y, cellSize, cellSize);
		//         snake.y = 0;
		//         context.fillRect(snake.x, snake.y, cellSize, cellSize);
		//     }
		// }
		// if(snakeHeadY < 0){
		//     for(let i = 0; i < snake.length; i++) {
...
// Кнопка заново
	function RestartGame() {
		clearInterval(game);
		reload_interval()
		// let againBtn = document.createElement('input');
		// againBtn.setAttribute('type', 'button');
		// againBtn.value = 'Заново';
